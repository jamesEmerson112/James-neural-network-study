...
| 1973 | **OPEC oil embargo** | — | Energy crisis triggers gas lines and economic shock across America. Government R&D budgets face new scrutiny. Ironically, the resulting Department of Energy expansion would employ Werbos (1979-1989) building the energy forecasting models that became his day job while backprop sat unread |
| 1974 | **Nixon resigns / Vietnam War ending** | — | America in full disillusionment: Watergate, a lost war, economic crisis. The Lighthill Report in the UK devastates AI funding there too. The national mood is "what went wrong?" not "what's the next breakthrough?" — the worst possible moment to publish a revolutionary AI thesis that nobody asked for |
| 1974 | **Backprop for neural nets** | Paul Werbos (Harvard) | PhD thesis "Beyond Regression": first to explicitly apply the chain rule backward through layers to train neural networks. A 26-year-old living in Roxbury (one of Boston's poorest neighborhoods), submitting a thesis containing the key to all modern AI — while the President is resigning, the country is losing a war, and the AI establishment has declared neural networks dead. Inspired by Freud's "psychic energy" and control theory. Offered to co-author with Minsky — was rejected. The right answer, 12 years too early — almost nobody read it. [Full story](06b_werbos_backpropagation_the_right_answer_too_early.md) |
